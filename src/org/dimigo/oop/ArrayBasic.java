...
public class ArrayBasic {
    public static void main(String[] args) {
        // 기본형 타입 배열
        // int, Loon, boolean, char, float, double, short, byte
        ...
        int[] intArr2 = new int[] {1, 2, 3, 4, 5}; // int[] intArr2 = {1, 2, 3, 4, 5};
        printArray(intArr2);
        ...
        String[] strArr2 = new String[] {"트와이스", "블랙핑크", "씨잼"}; // String[] strArr2 = {"트와이스", "블랙핑크", "씨잼"};
        printArray(strArr2);
